...
reg   [7:0] colorFormatLocal_reg_752;
reg    ap_block_state1;
reg   [7:0] motionSpeed_val_read_reg_758;
reg   [7:0] patternId_val_read_reg_763;
reg   [15:0] passthruEndY_val_read_reg_768;
reg   [15:0] passthruEndX_val_read_reg_773;
reg   [15:0] passthruStartY_val_read_reg_778;
reg   [15:0] passthruStartX_val_read_reg_783;
reg   [15:0] loopWidth_reg_788;
reg   [15:0] loopHeight_reg_794;
wire   [0:0] cmp8_fu_409_p2;
reg   [0:0] cmp8_reg_800;
wire   [13:0] empty_84_fu_415_p1;
reg   [13:0] empty_84_reg_805;
wire   [0:0] icmp_fu_439_p2;
reg   [0:0] icmp_reg_811;
reg   [9:0] tmp_reg_816;
reg   [10:0] barWidth_reg_821;
wire    ap_CS_fsm_state2;
wire   [7:0] empty_85_fu_539_p1;
reg   [7:0] empty_85_reg_827;
wire   [0:0] cmp33_i_fu_543_p2;
reg   [0:0] cmp33_i_reg_832;
wire   [9:0] barWidthMinSamples_fu_563_p2;
reg   [9:0] barWidthMinSamples_reg_837;
wire   [10:0] sub_i_i_i_fu_575_p2;
reg   [10:0] sub_i_i_i_reg_842;
wire   [16:0] sub35_i_fu_581_p2;
reg   [16:0] sub35_i_reg_847;
wire   [9:0] conv2_i_i15_i_fu_587_p3;
reg   [9:0] conv2_i_i15_i_reg_852;
wire   [9:0] conv2_i_i_i295_fu_595_p3;
reg   [9:0] conv2_i_i_i295_reg_857;
wire   [16:0] sub10_i_fu_603_p2;
reg   [16:0] sub10_i_reg_862;
reg   [15:0] y_1_reg_867;
wire    ap_CS_fsm_state3;
reg   [9:0] outpix_load_reg_876;
reg   [9:0] outpix_1_load_reg_881;
reg   [9:0] outpix_2_load_reg_886;
wire   [0:0] ult_fu_636_p2;
reg   [0:0] ult_reg_891;
wire   [0:0] cmp11_i_fu_641_p2;
reg   [0:0] cmp11_i_reg_896;
wire   [0:0] rev_fu_670_p2;
reg   [0:0] rev_reg_901;
wire    ap_CS_fsm_state4;
wire   [0:0] cmp_i_fu_676_p2;
reg   [0:0] cmp_i_reg_906;
...
wire   [9:0] add_ln750_fu_658_p2;
wire   [0:0] icmp_ln563_fu_612_p2;
reg   [15:0] y_fu_184;
wire   [15:0] add_ln563_fu_617_p2;
wire   [7:0] zext_ln563_fu_483_p1;
wire   [7:0] zext_ln1575_fu_471_p1;
wire   [7:0] zext_ln1412_fu_463_p1;
...
wire   [13:0] empty_86_fu_419_p1;
wire   [6:0] tmp_9_fu_429_p4;
wire   [13:0] add5_i_fu_423_p2;
wire   [13:0] add_i_fu_524_p2;
wire   [13:0] add2_i_fu_548_p2;
wire   [9:0] p_cast_fu_553_p4;
wire   [10:0] barHeight_cast_fu_572_p1;
wire   [16:0] width_val_cast10_fu_521_p1;
wire   [16:0] height_val_cast11_fu_569_p1;
wire   [16:0] zext_ln563_1_fu_632_p1;
wire   [9:0] zext_ln750_fu_655_p1;
reg   [4:0] ap_NS_fsm;
...
design_1_v_tpg_0_0_tpgBackground_Pipeline_VITIS_LOOP_565_2 grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302(
    ...
    .outpix_2(outpix_2_load_reg_886),
    .outpix_1(outpix_1_load_reg_881),
    .outpix(outpix_load_reg_876),
    .loopWidth(loopWidth_reg_788),
    .conv2_i_i_i295(conv2_i_i_i295_reg_857),
    .conv2_i_i15_i(conv2_i_i15_i_reg_852),
    .cmp8(cmp8_reg_800),
    .patternId_val_load(patternId_val_read_reg_763),
    .colorFormatLocal(colorFormatLocal_reg_752),
    .empty(empty_85_reg_827),
    .cmp33_i(cmp33_i_reg_832),
    .barWidth_cast(barWidth_reg_821),
    .barWidth(barWidth_reg_821),
    .y(y_1_reg_867),
    .sub_i_i_i(sub_i_i_i_reg_842),
    .barWidthMinSamples(barWidthMinSamples_reg_837),
    .cmp11_i(cmp11_i_reg_896),
    .cmp_i(cmp_i_reg_906),
    .sub35_i(sub35_i_reg_847),
    .icmp(icmp_reg_811),
    .passthruEndX_val_load(passthruEndX_val_read_reg_773),
    .passthruStartX_val_load(passthruStartX_val_read_reg_783),
    .passthruStartY_val_load(passthruStartY_val_read_reg_778),
    .rev(rev_reg_901),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln563_fu_612_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        hBarSel_0_loc_0_fu_208 <= zext_ln1575_fu_471_p1;
    end else if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_hBarSel_0_loc_1_out_o_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        hBarSel_2_0_loc_0_fu_200 <= zext_ln563_fu_483_p1;
    end else if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_hBarSel_2_0_loc_1_out_o_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_hBarSel_3_0_loc_1_out_o_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_vBarSel_1_loc_1_out_o_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        vBarSel_loc_0_fu_212 <= zext_ln1412_fu_463_p1;
    end else if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_vBarSel_loc_1_out_o_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        y_fu_184 <= 16'd0;
    end else if (((icmp_ln563_fu_612_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        y_fu_184 <= add_ln563_fu_617_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        barWidthMinSamples_reg_837 <= barWidthMinSamples_fu_563_p2;
        barWidth_reg_821 <= {{add_i_fu_524_p2[13:3]}};
        cmp33_i_reg_832 <= cmp33_i_fu_543_p2;
        conv2_i_i15_i_reg_852[8 : 0] <= conv2_i_i15_i_fu_587_p3[8 : 0];
        conv2_i_i_i295_reg_857[9] <= conv2_i_i_i295_fu_595_p3[9];
        empty_85_reg_827 <= empty_85_fu_539_p1;
        sub10_i_reg_862 <= sub10_i_fu_603_p2;
        sub35_i_reg_847 <= sub35_i_fu_581_p2;
        sub_i_i_i_reg_842 <= sub_i_i_i_fu_575_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        cmp11_i_reg_896 <= cmp11_i_fu_641_p2;
        outpix_1_load_reg_881 <= outpix_1_fu_192;
        outpix_2_load_reg_886 <= outpix_2_fu_196;
        outpix_load_reg_876 <= outpix_fu_188;
        ult_reg_891 <= ult_fu_636_p2;
        y_1_reg_867 <= y_fu_184;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        cmp8_reg_800 <= cmp8_fu_409_p2;
        colorFormatLocal_reg_752 <= colorFormat_val_dout;
        empty_84_reg_805 <= empty_84_fu_415_p1;
        icmp_reg_811 <= icmp_fu_439_p2;
        loopHeight_reg_794 <= height_val_dout;
        loopWidth_reg_788 <= width_val_dout;
        motionSpeed_val_read_reg_758 <= motionSpeed_val_dout;
        passthruEndX_val_read_reg_773 <= passthruEndX_val_dout;
        passthruEndY_val_read_reg_768 <= passthruEndY_val_dout;
        passthruStartX_val_read_reg_783 <= passthruStartX_val_dout;
        passthruStartY_val_read_reg_778 <= passthruStartY_val_dout;
        patternId_val_read_reg_763 <= patternId_val_dout;
        tmp_reg_816 <= {{add5_i_fu_423_p2[13:4]}};
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        cmp_i_reg_906 <= cmp_i_fu_676_p2;
        rev_reg_901 <= rev_fu_670_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_hBarSel_0_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        hBarSel_0 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_hBarSel_0;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_hBarSel_2_0_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        hBarSel_2_0 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_hBarSel_2_0;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_hBarSel_3_0_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        hBarSel_3_0 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_hBarSel_3_0;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_outpix_4_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        outpix_1_fu_192 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_outpix_4_out;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_outpix_5_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        outpix_2_fu_196 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_outpix_5_out;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_outpix_3_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        outpix_fu_188 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_outpix_3_out;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_p_0_0_010243_out_o_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        p_0_0_010244_lcssa251_fu_172 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_p_0_0_010243_out_o;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_p_0_0_0247_out_o_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        p_0_0_0248_lcssa257_fu_180 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_p_0_0_0247_out_o;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_p_0_0_09245_out_o_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        p_0_0_09246_lcssa254_fu_176 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_p_0_0_09245_out_o;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln563_fu_612_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        rampStart <= add_ln750_fu_658_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_vBarSel_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        vBarSel <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_vBarSel;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_vBarSel_1_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        vBarSel_1 <= grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_vBarSel_1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_302_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end
...
assign add2_i_fu_548_p2 = (empty_84_reg_805 + 14'd15);

assign add5_i_fu_423_p2 = (empty_86_fu_419_p1 + 14'd15);

assign add_i_fu_524_p2 = (empty_84_reg_805 + 14'd7);

assign add_ln563_fu_617_p2 = (y_fu_184 + 16'd1);

assign add_ln750_fu_658_p2 = (rampStart + zext_ln750_fu_655_p1);
...
always @ (*) begin
    ap_block_state1 = ((colorFormat_val_empty_n == 1'b0) | (motionSpeed_val_empty_n == 1'b0) | (patternId_val_empty_n == 1'b0) | (enableInput_val_empty_n == 1'b0) | (passthruEndY_val_empty_n == 1'b0) | (passthruEndX_val_empty_n == 1'b0) | (passthruStartY_val_empty_n == 1'b0) | (passthruStartX_val_empty_n == 1'b0) | (width_val_empty_n == 1'b0) | (height_val_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (colorFormat_val20_c_full_n == 1'b0) | (ap_start == 1'b0) | (width_val7_c_full_n == 1'b0) | (height_val4_c_full_n == 1'b0));
end

assign barHeight_cast_fu_572_p1 = tmp_reg_816;

assign barWidthMinSamples_fu_563_p2 = ($signed(p_cast_fu_553_p4) + $signed(10'd1023));

assign cmp11_i_fu_641_p2 = ((sub10_i_reg_862 == zext_ln563_1_fu_632_p1) ? 1'b1 : 1'b0);

assign cmp33_i_fu_543_p2 = ((colorFormatLocal_reg_752 == 8'd0) ? 1'b1 : 1'b0);

assign cmp8_fu_409_p2 = ((enableInput_val_dout != 8'd0) ? 1'b1 : 1'b0);

assign cmp_i_fu_676_p2 = ((y_1_reg_867 == 16'd0) ? 1'b1 : 1'b0);
...
assign conv2_i_i15_i_fu_587_p3 = ((cmp33_i_fu_543_p2[0:0] == 1'b1) ? 10'd1023 : 10'd512);

assign conv2_i_i_i295_fu_595_p3 = ((cmp33_i_fu_543_p2[0:0] == 1'b1) ? 10'd0 : 10'd512);

assign empty_83_fu_404_p1 = height_val_dout[10:0];

assign empty_84_fu_415_p1 = width_val_dout[13:0];

assign empty_85_fu_539_p1 = s[7:0];

assign empty_86_fu_419_p1 = height_val_dout[13:0];
...
assign height_val_cast11_fu_569_p1 = loopHeight_reg_794;

assign height_val_read = height_val_read_local;

assign icmp_fu_439_p2 = ((tmp_9_fu_429_p4 != 7'd0) ? 1'b1 : 1'b0);

assign icmp_ln563_fu_612_p2 = ((y_fu_184 == loopHeight_reg_794) ? 1'b1 : 1'b0);
...
assign p_cast_fu_553_p4 = {{add2_i_fu_548_p2[13:4]}};
...
assign rev_fu_670_p2 = (ult_reg_891 ^ 1'd1);

assign sub10_i_fu_603_p2 = ($signed(height_val_cast11_fu_569_p1) + $signed(17'd131071));

assign sub35_i_fu_581_p2 = ($signed(width_val_cast10_fu_521_p1) + $signed(17'd131071));

assign sub_i_i_i_fu_575_p2 = ($signed(barHeight_cast_fu_572_p1) + $signed(11'd2047));

assign tmp_9_fu_429_p4 = {{colorFormat_val_dout[7:1]}};

assign ult_fu_636_p2 = ((y_fu_184 < passthruEndY_val_read_reg_768) ? 1'b1 : 1'b0);

assign width_val7_c_din = empty_fu_399_p1;

assign width_val7_c_write = width_val7_c_write_local;

assign width_val_cast10_fu_521_p1 = loopWidth_reg_788;

assign width_val_read = width_val_read_local;

assign zext_ln1412_fu_463_p1 = vBarSel;

assign zext_ln1575_fu_471_p1 = hBarSel_0;

assign zext_ln563_1_fu_632_p1 = y_fu_184;

assign zext_ln563_fu_483_p1 = hBarSel_2_0;

assign zext_ln750_fu_655_p1 = motionSpeed_val_read_reg_758;

always @ (posedge ap_clk) begin
    conv2_i_i15_i_reg_852[9] <= 1'b1;
    conv2_i_i_i295_reg_857[8:0] <= 9'b000000000;
end
