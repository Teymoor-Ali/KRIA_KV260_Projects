...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgUnzip_dout { I 30 vector } imgUnzip_num_data_valid { I 3 vector } imgUnzip_fifo_cap { I 3 vector } imgUnzip_empty_n { I 1 bit } imgUnzip_read { O 1 bit } } \
} "
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_demosaic_0_0_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
