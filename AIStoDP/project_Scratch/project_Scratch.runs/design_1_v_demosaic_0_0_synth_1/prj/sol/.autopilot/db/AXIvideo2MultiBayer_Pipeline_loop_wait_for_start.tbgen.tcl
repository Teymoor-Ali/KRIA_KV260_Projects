set moduleName AXIvideo2MultiBayer_Pipeline_loop_wait_for_start
set isTopModule 0
...
set C_modelName {AXIvideo2MultiBayer_Pipeline_loop_wait_for_start}
...
set C_modelArgList {
	...
	{ axi_data_out int 10 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_video_V_data_V", "interface" : "axis", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_out", "interface" : "wire", "bitwidth" : 10, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ axi_data_out sc_out sc_lv 10 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_out", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "axi_data_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	axi_data_out { ap_vld {  { axi_data_out out_data 1 10 }  { axi_data_out_ap_vld out_vld 1 1 } } }
