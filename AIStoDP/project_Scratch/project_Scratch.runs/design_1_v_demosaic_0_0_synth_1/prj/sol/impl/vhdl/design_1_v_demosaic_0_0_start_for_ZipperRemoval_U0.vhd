...
architecture rtl of design_1_v_demosaic_0_0_start_for_ZipperRemoval_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component design_1_v_demosaic_0_0_start_for_ZipperRemoval_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_design_1_v_demosaic_0_0_start_for_ZipperRemoval_U0_ShiftReg : design_1_v_demosaic_0_0_start_for_ZipperRemoval_U0_ShiftReg
    generic map (
...
entity design_1_v_demosaic_0_0_start_for_ZipperRemoval_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end design_1_v_demosaic_0_0_start_for_ZipperRemoval_U0_ShiftReg;

architecture rtl of design_1_v_demosaic_0_0_start_for_ZipperRemoval_U0_ShiftReg is
