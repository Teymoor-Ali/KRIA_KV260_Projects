...
set C_modelArgList {
	...
	{ sub_i_i int 12 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "sof", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sub_i_i", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sub_i_i sc_in sc_lv 12 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_i_i", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "sub_i_i", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sub_i_i { ap_stable {  { sub_i_i in_data 0 12 } } }
