...
architecture behav of design_1_v_tpg_0_0_v_tpg is 
    ...
    "design_1_v_tpg_0_0_v_tpg,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=6.734000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.827500,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=4003,HLS_SYN_LUT=6120,HLS_VERSION=2024_1}";
    ...
    signal icmp_ln500_fu_475_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln500_reg_543 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal motionSpeed_read_reg_605 : STD_LOGIC_VECTOR (7 downto 0);
    signal colorFormat_read_reg_610 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TKEEP : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_fid : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_ap_start : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_349_s_axis_video_TREADY : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TVALID : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TREADY : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_349_fid_ap_vld : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_349_ap_done : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_349_ap_ready : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_349_ap_idle : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_349_ap_continue : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_469_ap_start : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_469_ap_done : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_469_ap_idle : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_469_ap_ready : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_469_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal count_new_0_reg_338 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln503_fu_491_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_ready : STD_LOGIC := '0';
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done : STD_LOGIC := '0';
    signal ap_block_state4_on_subcall_done : BOOLEAN;
    signal ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_ready : STD_LOGIC;
    signal select_ln505_fu_523_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_501_p4 : STD_LOGIC_VECTOR (28 downto 0);
    signal icmp_ln505_fu_511_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln507_fu_517_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    grp_v_tpgHlsDataFlow_fu_349 : component design_1_v_tpg_0_0_v_tpgHlsDataFlow
    port map (
    ...
    grp_reg_unsigned_short_s_fu_469 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_349_ap_done = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_ready <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_ready <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_349_ap_ready = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_ready <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    grp_v_tpgHlsDataFlow_fu_349_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_v_tpgHlsDataFlow_fu_349_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state3) or ((ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state4)))) then 
                    grp_v_tpgHlsDataFlow_fu_349_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_v_tpgHlsDataFlow_fu_349_ap_ready = ap_const_logic_1)) then 
                    grp_v_tpgHlsDataFlow_fu_349_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
    ...
    count_new_0_reg_338_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_fu_475_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                if ((icmp_ln503_fu_491_p2 = ap_const_lv1_0)) then 
                    count_new_0_reg_338 <= add_ln502_fu_485_p2;
                elsif ((icmp_ln503_fu_491_p2 = ap_const_lv1_1)) then 
                    count_new_0_reg_338 <= ap_const_lv32_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_reg_543 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_fu_475_p2 = ap_const_lv1_1) and (icmp_ln503_fu_491_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    add_ln502_fu_485_p2 <= std_logic_vector(unsigned(count) + unsigned(ap_const_lv32_1));
    add_ln507_fu_517_p2 <= std_logic_vector(unsigned(s) + unsigned(ap_const_lv32_1));
    ...
    ap_block_state4_on_subcall_done_assign_proc : process(ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_ready, ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done)
    begin
                ap_block_state4_on_subcall_done <= ((ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_ready and ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done) = ap_const_logic_0);
    end process;
    ...
    ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_ready <= (grp_v_tpgHlsDataFlow_fu_349_ap_ready or ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_ready);
    fid <= grp_v_tpgHlsDataFlow_fu_349_fid;

    grp_reg_unsigned_short_s_fu_469_ap_start_assign_proc : process(ap_start, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
            grp_reg_unsigned_short_s_fu_469_ap_start <= ap_const_logic_1;
        else 
            grp_reg_unsigned_short_s_fu_469_ap_start <= ap_const_logic_0;
        end if; 
    end process;


    grp_v_tpgHlsDataFlow_fu_349_ap_continue_assign_proc : process(ap_CS_fsm_state4, ap_block_state4_on_subcall_done)
    begin
        if (((ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
            grp_v_tpgHlsDataFlow_fu_349_ap_continue <= ap_const_logic_1;
        else 
            grp_v_tpgHlsDataFlow_fu_349_ap_continue <= ap_const_logic_0;
        end if; 
    end process;

    grp_v_tpgHlsDataFlow_fu_349_ap_start <= grp_v_tpgHlsDataFlow_fu_349_ap_start_reg;
    grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TREADY <= (m_axis_video_TREADY_int_regslice and ap_CS_fsm_state4);
    icmp_ln500_fu_475_p2 <= "1" when (grp_reg_unsigned_short_s_fu_469_ap_return = ap_const_lv16_1) else "0";
    icmp_ln503_fu_491_p2 <= "1" when (add_ln502_fu_485_p2 = ap_const_lv32_A) else "0";
    icmp_ln505_fu_511_p2 <= "1" when (signed(tmp_1_fu_501_p4) < signed(ap_const_lv29_1)) else "0";
    m_axis_video_TVALID <= regslice_both_m_axis_video_V_data_V_U_vld_out;
    m_axis_video_TVALID_int_regslice <= grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TVALID;
    s_axis_video_TREADY <= regslice_both_s_axis_video_V_data_V_U_ack_in;

    s_axis_video_TREADY_int_regslice_assign_proc : process(grp_v_tpgHlsDataFlow_fu_349_s_axis_video_TREADY, ap_CS_fsm_state4)
    begin
    ...
    select_ln505_fu_523_p3 <= 
        add_ln507_fu_517_p2 when (icmp_ln505_fu_511_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_1_fu_501_p4 <= s(31 downto 3);
end behav;
