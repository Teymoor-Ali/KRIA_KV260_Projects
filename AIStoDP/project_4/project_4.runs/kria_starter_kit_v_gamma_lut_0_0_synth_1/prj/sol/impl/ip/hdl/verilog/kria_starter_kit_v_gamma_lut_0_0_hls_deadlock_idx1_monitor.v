...
module kria_starter_kit_v_gamma_lut_0_0_hls_deadlock_idx1_monitor ( // for module kria_starter_kit_v_gamma_lut_0_0_v_gamma_lut_inst.AXIvideo2MultiPixStream_U0
    input wire clock,
    input wire reset,
