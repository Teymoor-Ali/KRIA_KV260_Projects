...
module kria_starter_kit_v_gamma_lut_0_0_hls_deadlock_idx0_monitor ( // for module kria_starter_kit_v_gamma_lut_0_0_v_gamma_lut_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 kria_starter_kit_v_gamma_lut_0_0_hls_deadlock_idx1_monitor kria_starter_kit_v_gamma_lut_0_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
