...
(* CORE_GENERATION_INFO="kria_starter_kit_v_gamma_lut_0_0_v_gamma_lut,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=3.390000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.474350,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=886,HLS_SYN_LUT=1629,HLS_VERSION=2024_1}" *)

module kria_starter_kit_v_gamma_lut_0_0_v_gamma_lut (
        s_axi_CTRL_AWVALID,
        s_axi_CTRL_AWREADY,
        s_axi_CTRL_AWADDR,
        s_axi_CTRL_WVALID,
...
kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi #(
...
kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream AXIvideo2MultiPixStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
kria_starter_kit_v_gamma_lut_0_0_Gamma Gamma_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
kria_starter_kit_v_gamma_lut_0_0_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
kria_starter_kit_v_gamma_lut_0_0_fifo_w24_d16_S imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kria_starter_kit_v_gamma_lut_0_0_fifo_w24_d16_S imgGamma_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kria_starter_kit_v_gamma_lut_0_0_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
`include "kria_starter_kit_v_gamma_lut_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "kria_starter_kit_v_gamma_lut_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //kria_starter_kit_v_gamma_lut_0_0_v_gamma_lut
