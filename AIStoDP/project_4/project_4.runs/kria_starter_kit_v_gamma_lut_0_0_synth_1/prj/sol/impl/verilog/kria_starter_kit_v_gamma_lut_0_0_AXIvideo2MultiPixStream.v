...
module kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [11:0] trunc_ln170_fu_203_p1;
reg   [11:0] trunc_ln170_reg_326;
reg    ap_block_state1;
wire   [11:0] trunc_ln171_fu_207_p1;
reg   [11:0] trunc_ln171_reg_331;
wire   [11:0] grp_reg_unsigned_short_s_fu_216_ap_return;
reg   [11:0] rows_reg_336;
wire    ap_CS_fsm_state4;
wire   [11:0] grp_reg_unsigned_short_s_fu_221_ap_return;
reg   [11:0] cols_reg_341;
wire   [0:0] cmp10251_fu_229_p2;
reg   [0:0] cmp10251_reg_349;
...
wire   [23:0] grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132_axi_data_out;
...
wire   [23:0] grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_imgRgb_din;
...
wire   [23:0] grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_axi_data_3_out;
...
wire   [23:0] grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180_axi_data_4_out;
...
kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_width grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
kria_starter_kit_v_gamma_lut_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_216(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
kria_starter_kit_v_gamma_lut_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_221(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        cmp10251_reg_349 <= cmp10251_fu_229_p2;
...
assign cmp10251_fu_229_p2 = ((grp_reg_unsigned_short_s_fu_221_ap_return != 12'd0) ? 1'b1 : 1'b0);
...
assign i_5_fu_249_p2 = (i_fu_78 + 12'd1);
...
assign select_ln216_fu_277_p3 = ((cmp10251_reg_349[0:0] == 1'b1) ? grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_eol_out : axi_last_2_reg_122);

assign trunc_ln170_fu_203_p1 = height[11:0];

assign trunc_ln171_fu_207_p1 = width[11:0];

assign xor_ln216_fu_235_p2 = (cmp10251_fu_229_p2 ^ 1'd1);

endmodule //kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream
