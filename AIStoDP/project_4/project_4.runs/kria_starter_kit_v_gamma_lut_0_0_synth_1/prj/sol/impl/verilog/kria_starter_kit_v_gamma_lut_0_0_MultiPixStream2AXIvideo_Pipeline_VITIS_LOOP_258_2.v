...
module kria_starter_kit_v_gamma_lut_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [12:0] zext_ln268_fu_166_p1;
reg    ap_done_reg;
...
always @ (*) begin
    ap_condition_183 = ((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln258_reg_193 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign icmp_ln258_fu_154_p2 = ((ap_sig_allocacmp_j_1 == empty) ? 1'b1 : 1'b0);

assign imgGamma_read = imgGamma_read_local;

assign j_2_fu_160_p2 = (ap_sig_allocacmp_j_1 + 12'd1);
...
endmodule //kria_starter_kit_v_gamma_lut_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2
