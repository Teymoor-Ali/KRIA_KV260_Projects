...
// ==============================================================
`timescale 1ns/1ps
module kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi
#(parameter
...
//------------------------Instantiation------------------
// int_gamma_lut_0
kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 128 )
...
module kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
