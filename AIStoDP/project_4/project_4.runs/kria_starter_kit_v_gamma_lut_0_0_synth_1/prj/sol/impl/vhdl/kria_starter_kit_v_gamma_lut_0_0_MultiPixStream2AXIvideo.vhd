...
entity kria_starter_kit_v_gamma_lut_0_0_MultiPixStream2AXIvideo is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    imgGamma_dout : IN STD_LOGIC_VECTOR (23 downto 0);
...
architecture behav of kria_starter_kit_v_gamma_lut_0_0_MultiPixStream2AXIvideo is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln249_fu_120_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal trunc_ln249_reg_180 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal trunc_ln250_fu_124_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal trunc_ln250_reg_185 : STD_LOGIC_VECTOR (11 downto 0);
    signal sub_i_i_fu_132_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal sub_i_i_reg_190 : STD_LOGIC_VECTOR (12 downto 0);
    signal icmp_ln256_fu_138_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln256_reg_195 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln256_fu_163_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln256_reg_203 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_start : STD_LOGIC;
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_done : STD_LOGIC;
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_idle : STD_LOGIC;
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_ready : STD_LOGIC;
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_imgGamma_read : STD_LOGIC;
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TREADY : STD_LOGIC;
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TVALID : STD_LOGIC;
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal sof_reg_84 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_start_reg : STD_LOGIC := '0';
    signal icmp_ln256_1_fu_152_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_fu_68 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal i_2_fu_157_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal empty_fu_128_p1 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    component kria_starter_kit_v_gamma_lut_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_gamma_lut_0_0_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96 : component kria_starter_kit_v_gamma_lut_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    regslice_both_m_axis_video_V_data_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 24)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_keep_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_strb_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_user_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_last_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_id_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_dest_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln256_1_fu_152_p2 = ap_const_lv1_0))) then 
                    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_ready = ap_const_logic_1)) then 
                    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln256_1_fu_152_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_block_state1, ap_CS_fsm_state2, grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_done, ap_CS_fsm_state3, icmp_ln256_1_fu_152_p2, ap_CS_fsm_state4, regslice_both_m_axis_video_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln256_1_fu_152_p2 = ap_const_lv1_1))) then
    ...
    and_ln256_fu_163_p2 <= (sof_reg_84 and icmp_ln256_reg_195);
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_done)
    begin
        if ((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_done = ap_const_logic_0)) then 
    ...
    empty_fu_128_p1 <= width(13 - 1 downto 0);
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_start <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_ap_start_reg;
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TREADY <= (m_axis_video_TREADY_int_regslice and ap_CS_fsm_state3);
    i_2_fu_157_p2 <= std_logic_vector(unsigned(i_fu_68) + unsigned(ap_const_lv12_1));
    icmp_ln256_1_fu_152_p2 <= "1" when (i_fu_68 = trunc_ln249_reg_180) else "0";
    icmp_ln256_fu_138_p2 <= "1" when (trunc_ln250_fu_124_p1 = ap_const_lv12_0) else "0";

    imgGamma_read_assign_proc : process(grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_imgGamma_read, ap_CS_fsm_state3)
    begin
    ...
    m_axis_video_TVALID_int_regslice <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TVALID;
    sub_i_i_fu_132_p2 <= std_logic_vector(unsigned(empty_fu_128_p1) + unsigned(ap_const_lv13_1FFF));
    trunc_ln249_fu_120_p1 <= height(12 - 1 downto 0);
    trunc_ln250_fu_124_p1 <= width(12 - 1 downto 0);
end behav;
