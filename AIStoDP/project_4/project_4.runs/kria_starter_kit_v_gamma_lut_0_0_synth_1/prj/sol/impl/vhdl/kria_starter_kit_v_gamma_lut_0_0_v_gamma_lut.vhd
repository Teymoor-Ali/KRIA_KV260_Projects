...
entity kria_starter_kit_v_gamma_lut_0_0_v_gamma_lut is
generic (
...
architecture behav of kria_starter_kit_v_gamma_lut_0_0_v_gamma_lut is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "kria_starter_kit_v_gamma_lut_0_0_v_gamma_lut,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=3.390000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.474350,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=886,HLS_SYN_LUT=1629,HLS_VERSION=2024_1}";
    ...
    signal Gamma_U0_gamma_lut_0_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal Gamma_U0_gamma_lut_0_ce0 : STD_LOGIC;
    signal Gamma_U0_gamma_lut_1_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal Gamma_U0_gamma_lut_1_ce0 : STD_LOGIC;
    signal Gamma_U0_gamma_lut_2_address0 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_gamma_lut_0_0_Gamma IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_gamma_lut_0_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_gamma_lut_0_0_fifo_w24_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_gamma_lut_0_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi IS
    generic (
...
begin
    CTRL_s_axi_U : component kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi
    generic map (
    ...
    AXIvideo2MultiPixStream_U0 : component kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Gamma_U0 : component kria_starter_kit_v_gamma_lut_0_0_Gamma
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    MultiPixStream2AXIvideo_U0 : component kria_starter_kit_v_gamma_lut_0_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    imgRgb_U : component kria_starter_kit_v_gamma_lut_0_0_fifo_w24_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    imgGamma_U : component kria_starter_kit_v_gamma_lut_0_0_fifo_w24_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component kria_starter_kit_v_gamma_lut_0_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
