...
entity kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln170_fu_203_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal trunc_ln170_reg_326 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal trunc_ln171_fu_207_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal trunc_ln171_reg_331 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_reg_unsigned_short_s_fu_216_ap_return : STD_LOGIC_VECTOR (11 downto 0);
    signal rows_reg_336 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal grp_reg_unsigned_short_s_fu_221_ap_return : STD_LOGIC_VECTOR (11 downto 0);
    signal cols_reg_341 : STD_LOGIC_VECTOR (11 downto 0);
    signal cmp10251_fu_229_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal cmp10251_reg_349 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132_axi_data_out : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_imgRgb_din : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_axi_data_3_out : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180_axi_data_4_out : STD_LOGIC_VECTOR (23 downto 0);
    ...
    component kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_width IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_gamma_lut_0_0_reg_unsigned_short_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132 : component kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152 : component kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_width
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180 : component kria_starter_kit_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_216 : component kria_starter_kit_v_gamma_lut_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_221 : component kria_starter_kit_v_gamma_lut_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    regslice_both_s_axis_video_V_data_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 24)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_keep_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_strb_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_user_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_last_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_id_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_dest_V_U : component kria_starter_kit_v_gamma_lut_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    cmp10251_fu_229_p2 <= "0" when (grp_reg_unsigned_short_s_fu_221_ap_return = ap_const_lv12_0) else "1";
    ...
    i_5_fu_249_p2 <= std_logic_vector(unsigned(i_fu_78) + unsigned(ap_const_lv12_1));
    ...
    select_ln216_fu_277_p3 <= 
        grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_eol_out when (cmp10251_reg_349(0) = '1') else 
        axi_last_2_reg_122;
    trunc_ln170_fu_203_p1 <= height(12 - 1 downto 0);
    trunc_ln171_fu_207_p1 <= width(12 - 1 downto 0);
    xor_ln216_fu_235_p2 <= (cmp10251_fu_229_p2 xor ap_const_lv1_1);
end behav;
