...
entity kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi is
generic (
...
port (
    ...
    gamma_lut_0_address0  :in   STD_LOGIC_VECTOR(7 downto 0);
    gamma_lut_0_ce0       :in   STD_LOGIC;
    gamma_lut_0_q0        :out  STD_LOGIC_VECTOR(15 downto 0);
    gamma_lut_1_address0  :in   STD_LOGIC_VECTOR(7 downto 0);
    gamma_lut_1_ce0       :in   STD_LOGIC;
    gamma_lut_1_q0        :out  STD_LOGIC_VECTOR(15 downto 0);
    gamma_lut_2_address0  :in   STD_LOGIC_VECTOR(7 downto 0);
...
end entity kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi;
...
architecture behave of kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi is
    ...
    constant ADDR_GAMMA_LUT_0_HIGH    : INTEGER := 16#09ff#;
    constant ADDR_GAMMA_LUT_1_BASE    : INTEGER := 16#1000#;
    constant ADDR_GAMMA_LUT_1_HIGH    : INTEGER := 16#11ff#;
    constant ADDR_GAMMA_LUT_2_BASE    : INTEGER := 16#1800#;
    constant ADDR_GAMMA_LUT_2_HIGH    : INTEGER := 16#19ff#;
    ...
    -- memory signals
    signal int_gamma_lut_0_address0 : UNSIGNED(6 downto 0);
    signal int_gamma_lut_0_ce0 : STD_LOGIC;
    signal int_gamma_lut_0_q0  : UNSIGNED(31 downto 0);
    signal int_gamma_lut_0_address1 : UNSIGNED(6 downto 0);
    ...
    signal int_gamma_lut_1_address0 : UNSIGNED(6 downto 0);
    signal int_gamma_lut_1_ce0 : STD_LOGIC;
    signal int_gamma_lut_1_q0  : UNSIGNED(31 downto 0);
    signal int_gamma_lut_1_address1 : UNSIGNED(6 downto 0);
    ...
    signal int_gamma_lut_2_address0 : UNSIGNED(6 downto 0);
    signal int_gamma_lut_2_ce0 : STD_LOGIC;
    signal int_gamma_lut_2_q0  : UNSIGNED(31 downto 0);
    signal int_gamma_lut_2_address1 : UNSIGNED(6 downto 0);
    ...
    component kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram is
        generic (
    ...
    end component kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_gamma_lut_0
int_gamma_lut_0 : kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- int_gamma_lut_1
int_gamma_lut_1 : kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- int_gamma_lut_2
int_gamma_lut_2 : kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- Memory logic ------------------
    -- gamma_lut_0
    int_gamma_lut_0_address0 <= SHIFT_RIGHT(UNSIGNED(gamma_lut_0_address0), 1)(6 downto 0);
    ...
    int_gamma_lut_0_address1 <= raddr(8 downto 2) when ar_hs = '1' else waddr(8 downto 2);
    ...
    -- gamma_lut_1
    int_gamma_lut_1_address0 <= SHIFT_RIGHT(UNSIGNED(gamma_lut_1_address0), 1)(6 downto 0);
    ...
    int_gamma_lut_1_address1 <= raddr(8 downto 2) when ar_hs = '1' else waddr(8 downto 2);
    ...
    -- gamma_lut_2
    int_gamma_lut_2_address0 <= SHIFT_RIGHT(UNSIGNED(gamma_lut_2_address0), 1)(6 downto 0);
    ...
    int_gamma_lut_2_address1 <= raddr(8 downto 2) when ar_hs = '1' else waddr(8 downto 2);
...
entity kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram;

architecture behave of kria_starter_kit_v_gamma_lut_0_0_CTRL_s_axi_ram is
