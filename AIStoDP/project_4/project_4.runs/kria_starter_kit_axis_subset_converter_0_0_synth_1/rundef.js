...
ISEStep( "vivado",
         "-log kria_starter_kit_axis_subset_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kria_starter_kit_axis_subset_converter_0_0.tcl" );
