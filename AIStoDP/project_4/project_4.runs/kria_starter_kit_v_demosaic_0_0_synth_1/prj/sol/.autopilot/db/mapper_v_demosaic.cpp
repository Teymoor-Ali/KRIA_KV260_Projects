...
auto* sm_axis_video_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_m_axis_video_V_dest_V);
  // DUT call
  v_demosaic(__xlx_apatb_param_width, __xlx_apatb_param_height, __xlx_apatb_param_bayer_phase, ss_axis_video_V_data_V->data<char>(), ss_axis_video_V_keep_V->data<char>(), ss_axis_video_V_strb_V->data<char>(), ss_axis_video_V_user_V->data<char>(), ss_axis_video_V_last_V->data<char>(), ss_axis_video_V_id_V->data<char>(), ss_axis_video_V_dest_V->data<char>(), sm_axis_video_V_data_V->data<int>(), sm_axis_video_V_keep_V->data<char>(), sm_axis_video_V_strb_V->data<char>(), sm_axis_video_V_user_V->data<char>(), sm_axis_video_V_last_V->data<char>(), sm_axis_video_V_id_V->data<char>(), sm_axis_video_V_dest_V->data<char>());
ss_axis_video_V_data_V->transfer((hls::stream<char>*)__xlx_apatb_param_s_axis_video_V_data_V);
