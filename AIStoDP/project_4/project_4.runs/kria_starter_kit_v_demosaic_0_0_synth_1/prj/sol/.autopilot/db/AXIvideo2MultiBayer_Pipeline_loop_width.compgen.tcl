...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video_TVALID { I 1 bit } s_axis_video_TDATA { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgBayer_din { O 8 vector } imgBayer_num_data_valid { I 3 vector } imgBayer_fifo_cap { I 3 vector } imgBayer_full_n { I 1 bit } imgBayer_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { axi_data_3_out { O 8 vector } axi_data_3_out_ap_vld { O 1 bit } } \
} "
}
