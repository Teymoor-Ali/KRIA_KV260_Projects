...
set Spec2ImplPortList { 
	imgUnzip { ap_fifo {  { imgUnzip_dout fifo_data_in 0 24 }  { imgUnzip_num_data_valid fifo_status_num_data_valid 0 3 }  { imgUnzip_fifo_cap fifo_update 0 3 }  { imgUnzip_empty_n fifo_status 0 1 }  { imgUnzip_read fifo_port_we 1 1 } } }
