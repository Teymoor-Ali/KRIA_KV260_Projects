...
entity kria_starter_kit_v_demosaic_0_0_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity kria_starter_kit_v_demosaic_0_0_regslice_both;

architecture behave of kria_starter_kit_v_demosaic_0_0_regslice_both is
