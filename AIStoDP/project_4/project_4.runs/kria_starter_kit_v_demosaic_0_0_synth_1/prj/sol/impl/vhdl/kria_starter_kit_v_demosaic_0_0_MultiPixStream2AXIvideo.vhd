...
entity kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln221_fu_124_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal trunc_ln221_reg_184 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal trunc_ln222_fu_128_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal trunc_ln222_reg_189 : STD_LOGIC_VECTOR (11 downto 0);
    signal sub_i_i_fu_136_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal sub_i_i_reg_194 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TVALID : STD_LOGIC;
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal empty_fu_132_p1 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    component kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100 : component kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    regslice_both_m_axis_video_V_data_V_U : component kria_starter_kit_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 24)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_keep_V_U : component kria_starter_kit_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_strb_V_U : component kria_starter_kit_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_user_V_U : component kria_starter_kit_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_last_V_U : component kria_starter_kit_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_id_V_U : component kria_starter_kit_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_m_axis_video_V_dest_V_U : component kria_starter_kit_v_demosaic_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    empty_fu_132_p1 <= WidthOut(13 - 1 downto 0);
    ...
    i_2_fu_161_p2 <= std_logic_vector(unsigned(i_fu_72) + unsigned(ap_const_lv12_1));
    icmp_ln228_1_fu_156_p2 <= "1" when (i_fu_72 = trunc_ln221_reg_184) else "0";
    icmp_ln228_fu_142_p2 <= "1" when (trunc_ln222_fu_128_p1 = ap_const_lv12_0) else "0";
    ...
    sub_i_i_fu_136_p2 <= std_logic_vector(unsigned(empty_fu_132_p1) + unsigned(ap_const_lv13_1FFF));
    trunc_ln221_fu_124_p1 <= Height(12 - 1 downto 0);
    trunc_ln222_fu_128_p1 <= WidthOut(12 - 1 downto 0);
end behav;
