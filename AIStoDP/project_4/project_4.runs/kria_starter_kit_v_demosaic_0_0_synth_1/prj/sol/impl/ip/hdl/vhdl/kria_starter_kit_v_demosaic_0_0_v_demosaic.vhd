...
entity kria_starter_kit_v_demosaic_0_0_v_demosaic is
generic (
...
architecture behav of kria_starter_kit_v_demosaic_0_0_v_demosaic is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "kria_starter_kit_v_demosaic_0_0_v_demosaic,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=3.390000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.474700,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=38,HLS_SYN_DSP=0,HLS_SYN_FF=9963,HLS_SYN_LUT=11176,HLS_VERSION=2024_1}";
    ...
    signal AXIvideo2MultiBayer_U0_imgBayer_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal Debayer_U0_imgRgb_din : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal ZipperRemoval_U0_imgUnzip_din : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal imgBayer_dout : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal imgUnzip_dout : STD_LOGIC_VECTOR (23 downto 0);
    ...
    component kria_starter_kit_v_demosaic_0_0_Block_entry_split_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_AXIvideo2MultiBayer IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_Debayer IS
    port (
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_ZipperRemoval IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        imgUnzip_dout : IN STD_LOGIC_VECTOR (23 downto 0);
        imgUnzip_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        imgUnzip_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
    ...
    component kria_starter_kit_v_demosaic_0_0_fifo_w16_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_fifo_w8_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_fifo_w24_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_start_for_ZipperRemoval_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_CTRL_s_axi IS
    generic (
...
begin
    CTRL_s_axi_U : component kria_starter_kit_v_demosaic_0_0_CTRL_s_axi
    generic map (
    ...
    Block_entry_split_proc_U0 : component kria_starter_kit_v_demosaic_0_0_Block_entry_split_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    AXIvideo2MultiBayer_U0 : component kria_starter_kit_v_demosaic_0_0_AXIvideo2MultiBayer
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Debayer_U0 : component kria_starter_kit_v_demosaic_0_0_Debayer
    port map (
    ...
    ZipperRemoval_U0 : component kria_starter_kit_v_demosaic_0_0_ZipperRemoval
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    MultiPixStream2AXIvideo_U0 : component kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    bayer_phase_assign_channel_U : component kria_starter_kit_v_demosaic_0_0_fifo_w16_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    imgBayer_U : component kria_starter_kit_v_demosaic_0_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    imgRgb_U : component kria_starter_kit_v_demosaic_0_0_fifo_w24_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    imgUnzip_U : component kria_starter_kit_v_demosaic_0_0_fifo_w24_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_ZipperRemoval_U0_U : component kria_starter_kit_v_demosaic_0_0_start_for_ZipperRemoval_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component kria_starter_kit_v_demosaic_0_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
