...
entity kria_starter_kit_v_demosaic_0_0_Debayer is
port (
...
architecture behav of kria_starter_kit_v_demosaic_0_0_Debayer is 
...
attribute shreg_extract : string;
    ...
    signal DebayerG_U0_imgG_din : STD_LOGIC_VECTOR (23 downto 0);
    signal DebayerG_U0_imgG_write : STD_LOGIC;
    signal DebayerG_U0_bayerPhase_c1_din : STD_LOGIC_VECTOR (15 downto 0);
    signal DebayerG_U0_bayerPhase_c1_write : STD_LOGIC;
    ...
    signal DebayerRatBorBatR_U0_imgRB_din : STD_LOGIC_VECTOR (23 downto 0);
    signal DebayerRatBorBatR_U0_imgRB_write : STD_LOGIC;
    signal DebayerRatBorBatR_U0_height : STD_LOGIC_VECTOR (11 downto 0);
    signal DebayerRatBorBatR_U0_width : STD_LOGIC_VECTOR (11 downto 0);
    signal DebayerRatBorBatR_U0_bayerPhase_c1_read : STD_LOGIC;
    ...
    signal DebayerRandBatG_U0_imgRgb_din : STD_LOGIC_VECTOR (23 downto 0);
    signal DebayerRandBatG_U0_imgRgb_write : STD_LOGIC;
    signal DebayerRandBatG_U0_height : STD_LOGIC_VECTOR (11 downto 0);
    signal DebayerRandBatG_U0_width : STD_LOGIC_VECTOR (11 downto 0);
    signal DebayerRandBatG_U0_bayerPhase_c_read : STD_LOGIC;
    signal imgG_full_n : STD_LOGIC;
    signal imgG_dout : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal bayerPhase_c1_full_n : STD_LOGIC;
    signal bayerPhase_c1_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal bayerPhase_c1_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal bayerPhase_c1_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal bayerPhase_c1_empty_n : STD_LOGIC;
    signal imgRB_full_n : STD_LOGIC;
    signal imgRB_dout : STD_LOGIC_VECTOR (23 downto 0);
    ...
    component kria_starter_kit_v_demosaic_0_0_DebayerG IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_DebayerRatBorBatR IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_DebayerRandBatG IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_fifo_w24_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_fifo_w16_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_start_for_DebayerRatBorBatR_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kria_starter_kit_v_demosaic_0_0_start_for_DebayerRandBatG_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    DebayerG_U0 : component kria_starter_kit_v_demosaic_0_0_DebayerG
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        bayerPhase_c1_din => DebayerG_U0_bayerPhase_c1_din,
        bayerPhase_c1_num_data_valid => bayerPhase_c1_num_data_valid,
        bayerPhase_c1_fifo_cap => bayerPhase_c1_fifo_cap,
        bayerPhase_c1_full_n => bayerPhase_c1_full_n,
        bayerPhase_c1_write => DebayerG_U0_bayerPhase_c1_write);

    DebayerRatBorBatR_U0 : component kria_starter_kit_v_demosaic_0_0_DebayerRatBorBatR
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        bayerPhase_c1_dout => bayerPhase_c1_dout,
        bayerPhase_c1_num_data_valid => bayerPhase_c1_num_data_valid,
        bayerPhase_c1_fifo_cap => bayerPhase_c1_fifo_cap,
        bayerPhase_c1_empty_n => bayerPhase_c1_empty_n,
        bayerPhase_c1_read => DebayerRatBorBatR_U0_bayerPhase_c1_read,
    ...
    DebayerRandBatG_U0 : component kria_starter_kit_v_demosaic_0_0_DebayerRandBatG
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    imgG_U : component kria_starter_kit_v_demosaic_0_0_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    bayerPhase_c1_U : component kria_starter_kit_v_demosaic_0_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => DebayerG_U0_bayerPhase_c1_din,
        if_full_n => bayerPhase_c1_full_n,
        if_write => DebayerG_U0_bayerPhase_c1_write,
        if_dout => bayerPhase_c1_dout,
        if_num_data_valid => bayerPhase_c1_num_data_valid,
        if_fifo_cap => bayerPhase_c1_fifo_cap,
        if_empty_n => bayerPhase_c1_empty_n,
        if_read => DebayerRatBorBatR_U0_bayerPhase_c1_read);

    imgRB_U : component kria_starter_kit_v_demosaic_0_0_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bayerPhase_c_U : component kria_starter_kit_v_demosaic_0_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_DebayerRatBorBatR_U0_U : component kria_starter_kit_v_demosaic_0_0_start_for_DebayerRatBorBatR_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_DebayerRandBatG_U0_U : component kria_starter_kit_v_demosaic_0_0_start_for_DebayerRandBatG_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    begin
        ...
        DebayerRandBatG_U0_height <= resvalue(12-1 downto 0);
    end process;
    ...
    begin
        ...
        res_mask := res_mask(16-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        DebayerRandBatG_U0_width <= resvalue(12-1 downto 0);
    end process;
    ...
    begin
        ...
        res_mask := res_mask(16-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        DebayerRatBorBatR_U0_height <= resvalue(12-1 downto 0);
    end process;
    ...
    begin
        ...
        res_mask := res_mask(16-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        DebayerRatBorBatR_U0_width <= resvalue(12-1 downto 0);
    end process;
