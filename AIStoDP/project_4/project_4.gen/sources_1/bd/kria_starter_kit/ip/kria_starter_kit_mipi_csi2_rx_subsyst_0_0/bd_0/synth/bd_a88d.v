...
//--------------------------------------------------------------------------------
//Command: generate_target bd_a88d.bd
//Design : bd_a88d
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_a88d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_a88d,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "kria_starter_kit_mipi_csi2_rx_subsyst_0_0.hwdef" *) 
module bd_a88d
   (clkoutphy_in,
    csirxss_csi_irq,
  ...
  assign clkoutphy_in_1 = clkoutphy_in;
  ...
  assign pll_lock_in_1 = pll_lock_in;
  ...
  bd_a88d_phy_0 phy
       (.cl_enable(phy_rx_mipi_ppi_if_CL_ENABLE),
        ...
        .pll_lock_in(pll_lock_in_1),
        .rxbyteclkhs(phy_rxbyteclkhs));
  bd_a88d_r_sync_0 r_sync
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
