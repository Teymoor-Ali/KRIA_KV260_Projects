...
#ifndef _kria_starter_kit_xlconcat_0_0_core_h_
#define _kria_starter_kit_xlconcat_0_0_core_h_
...
class kria_starter_kit_xlconcat_0_0_core : public sc_module 
{
    public: 
       kria_starter_kit_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(kria_starter_kit_xlconcat_0_0_core);
    ...
    virtual ~kria_starter_kit_xlconcat_0_0_core() = default;
