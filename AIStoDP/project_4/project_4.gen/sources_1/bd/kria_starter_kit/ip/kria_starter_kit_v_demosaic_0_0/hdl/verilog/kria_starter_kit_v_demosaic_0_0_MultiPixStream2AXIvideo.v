...
module kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [11:0] trunc_ln221_fu_124_p1;
reg   [11:0] trunc_ln221_reg_184;
reg    ap_block_state1;
wire   [11:0] trunc_ln222_fu_128_p1;
reg   [11:0] trunc_ln222_reg_189;
wire   [12:0] sub_i_i_fu_136_p2;
reg   [12:0] sub_i_i_reg_194;
wire   [0:0] icmp_ln228_fu_142_p2;
reg   [0:0] icmp_ln228_reg_199;
wire   [0:0] and_ln228_fu_167_p2;
reg   [0:0] and_ln228_reg_207;
wire    ap_CS_fsm_state2;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_start;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_done;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_idle;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_ready;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_imgUnzip_read;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TREADY;
wire   [23:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TDATA;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TVALID;
wire   [2:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TKEEP;
wire   [2:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TSTRB;
wire   [0:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TUSER;
wire   [0:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TLAST;
wire   [0:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TID;
wire   [0:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TDEST;
reg   [0:0] sof_reg_88;
wire    ap_CS_fsm_state3;
reg    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_start_reg;
wire   [0:0] icmp_ln228_1_fu_156_p2;
reg   [11:0] i_fu_72;
wire   [11:0] i_2_fu_161_p2;
wire   [12:0] empty_fu_132_p1;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
#0 grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_start_reg = 1'b0;
#0 i_fu_72 = 12'd0;
end

kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2 grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln228_1_fu_156_p2 == 1'd0))) begin
            grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_start_reg <= 1'b1;
        end else if ((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_ready == 1'b1)) begin
            grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_72 <= 12'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln228_1_fu_156_p2 == 1'd0))) begin
        i_fu_72 <= i_2_fu_161_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln228_1_fu_156_p2 == 1'd1))) begin
...
assign and_ln228_fu_167_p2 = (sof_reg_88 & icmp_ln228_reg_199);
...
assign empty_fu_132_p1 = WidthOut[12:0];

assign grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_start = grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_ap_start_reg;

assign grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state3);

assign i_2_fu_161_p2 = (i_fu_72 + 12'd1);

assign icmp_ln228_1_fu_156_p2 = ((i_fu_72 == trunc_ln221_reg_184) ? 1'b1 : 1'b0);

assign icmp_ln228_fu_142_p2 = ((trunc_ln222_fu_128_p1 == 12'd0) ? 1'b1 : 1'b0);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign m_axis_video_TVALID_int_regslice = grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_230_2_fu_100_m_axis_video_TVALID;

assign sub_i_i_fu_136_p2 = ($signed(empty_fu_132_p1) + $signed(13'd8191));

assign trunc_ln221_fu_124_p1 = Height[11:0];

assign trunc_ln222_fu_128_p1 = WidthOut[11:0];

endmodule //kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo
