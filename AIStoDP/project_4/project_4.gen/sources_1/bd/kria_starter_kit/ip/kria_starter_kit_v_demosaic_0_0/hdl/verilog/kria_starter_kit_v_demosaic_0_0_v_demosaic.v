...
module kria_starter_kit_v_demosaic_0_0_v_demosaic (
        s_axi_CTRL_AWVALID,
        s_axi_CTRL_AWREADY,
        s_axi_CTRL_AWADDR,
        s_axi_CTRL_WVALID,
...
kria_starter_kit_v_demosaic_0_0_CTRL_s_axi #(
...
kria_starter_kit_v_demosaic_0_0_Block_entry_split_proc Block_entry_split_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
kria_starter_kit_v_demosaic_0_0_AXIvideo2MultiBayer AXIvideo2MultiBayer_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
kria_starter_kit_v_demosaic_0_0_Debayer Debayer_U0(
...
kria_starter_kit_v_demosaic_0_0_ZipperRemoval ZipperRemoval_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
kria_starter_kit_v_demosaic_0_0_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
kria_starter_kit_v_demosaic_0_0_fifo_w16_d2_S_x bayer_phase_assign_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kria_starter_kit_v_demosaic_0_0_fifo_w8_d3_S imgBayer_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kria_starter_kit_v_demosaic_0_0_fifo_w24_d2_S_x imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kria_starter_kit_v_demosaic_0_0_fifo_w24_d2_S_x imgUnzip_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kria_starter_kit_v_demosaic_0_0_start_for_ZipperRemoval_U0 start_for_ZipperRemoval_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
kria_starter_kit_v_demosaic_0_0_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Block_entry_split_proc_U0_ap_continue = bayer_phase_assign_channel_full_n;
...
assign ap_idle = ((bayer_phase_assign_channel_empty_n ^ 1'b1) & ZipperRemoval_U0_ap_idle & MultiPixStream2AXIvideo_U0_ap_idle & Debayer_U0_ap_idle & Block_entry_split_proc_U0_ap_idle & AXIvideo2MultiBayer_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_Block_entry_split_proc_U0_ap_ready & ap_sync_AXIvideo2MultiBayer_U0_ap_ready);
...
`include "kria_starter_kit_v_demosaic_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "kria_starter_kit_v_demosaic_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //kria_starter_kit_v_demosaic_0_0_v_demosaic
