...
-- Date        : Thu Jun 13 16:02:20 2024
-- Host        : Tey running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               f:/Projects/Vivado/project_4/project_4.gen/sources_1/bd/kria_starter_kit/ip/kria_starter_kit_clk_wiz_0_0/kria_starter_kit_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : kria_starter_kit_clk_wiz_0_0
...
entity kria_starter_kit_clk_wiz_0_0_clk_wiz is
  port (
...
end kria_starter_kit_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of kria_starter_kit_clk_wiz_0_0_clk_wiz is
  signal clk_in1_kria_starter_kit_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_kria_starter_kit_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_kria_starter_kit_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_kria_starter_kit_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_kria_starter_kit_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_kria_starter_kit_clk_wiz_0_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 14.750000,
      ...
      CLKIN1 => clk_in1_kria_starter_kit_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_kria_starter_kit_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_kria_starter_kit_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity kria_starter_kit_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    reset : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of kria_starter_kit_clk_wiz_0_0 : entity is true;
end kria_starter_kit_clk_wiz_0_0;

architecture STRUCTURE of kria_starter_kit_clk_wiz_0_0 is
begin
inst: entity work.kria_starter_kit_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
