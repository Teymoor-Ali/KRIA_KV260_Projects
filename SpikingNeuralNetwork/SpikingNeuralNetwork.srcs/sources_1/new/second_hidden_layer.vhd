...
-- Module Name: second_hidden_layer - Behavioral
-- Description: Second hidden layer with 10 neurons for classification.
----------------------------------------------------------------------------------
-- second_hidden_layer.vhd
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
use IEEE.NUMERIC_STD.ALL;

entity second_hidden_layer is
    generic (
        WEIGHT_WIDTH           : integer := 32;
        POTENTIAL_WIDTH        : integer := 48;
        NUM_PREV_LAYER_NEURONS : integer := 36;
        NUM_CURR_LAYER_NEURONS : integer := 10;
...
end second_hidden_layer;

architecture Behavioral of second_hidden_layer is

begin

    -- Generate neurons for the second hidden layer
