...
(* CORE_GENERATION_INFO="design_1_v_tpg_0_0_v_tpg,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.392000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=9,HLS_SYN_DSP=0,HLS_SYN_FF=8885,HLS_SYN_LUT=9732,HLS_VERSION=2024_1}" *)
...
reg   [31:0] count;
reg   [31:0] s;
wire   [0:0] icmp_ln500_fu_647_p2;
reg   [0:0] icmp_ln500_reg_715;
wire    ap_CS_fsm_state2;
wire   [31:0] add_ln502_fu_657_p2;
reg   [15:0] height_read_reg_727;
wire    ap_CS_fsm_state3;
reg   [15:0] width_read_reg_732;
reg   [15:0] field_id_read_reg_737;
reg   [15:0] passthruStartX_read_reg_747;
reg   [15:0] passthruStartY_read_reg_752;
reg   [15:0] passthruEndX_read_reg_757;
reg   [15:0] passthruEndY_read_reg_762;
reg   [7:0] enableInput_read_reg_767;
reg   [7:0] bckgndId_read_reg_772;
reg   [7:0] motionSpeed_read_reg_777;
reg   [7:0] colorFormat_read_reg_782;
reg   [15:0] ZplateHorContStart_read_reg_787;
reg   [15:0] ZplateHorContDelta_read_reg_792;
reg   [15:0] ZplateVerContStart_read_reg_797;
reg   [15:0] ZplateVerContDelta_read_reg_802;
reg   [7:0] dpDynamicRange_read_reg_807;
reg   [7:0] dpYUVCoef_read_reg_812;
wire   [31:0] grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TDATA;
wire   [3:0] grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TKEEP;
wire   [3:0] grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TSTRB;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TUSER;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TLAST;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TID;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TDEST;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_447_fid;
wire    grp_v_tpgHlsDataFlow_fu_447_ap_start;
wire    grp_v_tpgHlsDataFlow_fu_447_s_axis_video_TREADY;
wire    grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID;
wire    grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TREADY;
wire    grp_v_tpgHlsDataFlow_fu_447_fid_ap_vld;
wire    grp_v_tpgHlsDataFlow_fu_447_ap_done;
wire    grp_v_tpgHlsDataFlow_fu_447_ap_ready;
wire    grp_v_tpgHlsDataFlow_fu_447_ap_idle;
reg    grp_v_tpgHlsDataFlow_fu_447_ap_continue;
reg    grp_reg_unsigned_short_s_fu_641_ap_start;
wire    grp_reg_unsigned_short_s_fu_641_ap_done;
wire    grp_reg_unsigned_short_s_fu_641_ap_idle;
wire    grp_reg_unsigned_short_s_fu_641_ap_ready;
wire   [15:0] grp_reg_unsigned_short_s_fu_641_ap_return;
reg   [31:0] count_new_0_reg_436;
wire   [0:0] icmp_ln503_fu_663_p2;
reg    grp_v_tpgHlsDataFlow_fu_447_ap_start_reg;
wire    ap_CS_fsm_state4;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done;
reg    ap_block_state4_on_subcall_done;
wire    ap_sync_grp_v_tpgHlsDataFlow_fu_447_ap_ready;
wire   [31:0] select_ln505_fu_695_p3;
wire   [28:0] tmp_1_fu_673_p4;
wire   [0:0] icmp_ln505_fu_683_p2;
wire   [31:0] add_ln507_fu_689_p2;
...
#0 count = 32'd0;
#0 s = 32'd0;
#0 grp_v_tpgHlsDataFlow_fu_447_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready = 1'b0;
#0 ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done = 1'b0;
end

design_1_v_tpg_0_0_v_tpgHlsDataFlow grp_v_tpgHlsDataFlow_fu_447(
    ...
    .ZplateHorContStart_val21_ap_vld(1'b1),
    .ZplateHorContDelta_val22_ap_vld(1'b1),
    .ZplateVerContStart_val23_ap_vld(1'b1),
    .ZplateVerContDelta_val24_ap_vld(1'b1),
    .dpDynamicRange_val25_ap_vld(1'b1),
    .dpYUVCoef_val26_ap_vld(1'b1),
...
design_1_v_tpg_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_641(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done <= 1'b0;
        end else if ((grp_v_tpgHlsDataFlow_fu_447_ap_done == 1'b1)) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready <= 1'b0;
        end else if ((grp_v_tpgHlsDataFlow_fu_447_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_v_tpgHlsDataFlow_fu_447_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state3) | ((ap_sync_grp_v_tpgHlsDataFlow_fu_447_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state4)))) begin
            grp_v_tpgHlsDataFlow_fu_447_ap_start_reg <= 1'b1;
        end else if ((grp_v_tpgHlsDataFlow_fu_447_ap_ready == 1'b1)) begin
            grp_v_tpgHlsDataFlow_fu_447_ap_start_reg <= 1'b0;
        end
    end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln500_fu_647_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        if ((icmp_ln503_fu_663_p2 == 1'd0)) begin
            count_new_0_reg_436 <= add_ln502_fu_657_p2;
        end else if ((icmp_ln503_fu_663_p2 == 1'd1)) begin
            count_new_0_reg_436 <= 32'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln500_reg_715 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln500_fu_647_p2 == 1'd1) & (icmp_ln503_fu_663_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        grp_reg_unsigned_short_s_fu_641_ap_start = 1'b1;
    end else begin
        grp_reg_unsigned_short_s_fu_641_ap_start = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
        grp_v_tpgHlsDataFlow_fu_447_ap_continue = 1'b1;
    end else begin
        grp_v_tpgHlsDataFlow_fu_447_ap_continue = 1'b0;
    end
end
...
assign add_ln502_fu_657_p2 = (count + 32'd1);

assign add_ln507_fu_689_p2 = (s + 32'd1);
...
always @ (*) begin
    ap_block_state4_on_subcall_done = ((ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready & ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done) == 1'b0);
end
...
assign ap_sync_grp_v_tpgHlsDataFlow_fu_447_ap_ready = (grp_v_tpgHlsDataFlow_fu_447_ap_ready | ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready);

assign fid = grp_v_tpgHlsDataFlow_fu_447_fid;

assign grp_v_tpgHlsDataFlow_fu_447_ap_start = grp_v_tpgHlsDataFlow_fu_447_ap_start_reg;

assign grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state4);

assign icmp_ln500_fu_647_p2 = ((grp_reg_unsigned_short_s_fu_641_ap_return == 16'd1) ? 1'b1 : 1'b0);

assign icmp_ln503_fu_663_p2 = ((add_ln502_fu_657_p2 == 32'd10) ? 1'b1 : 1'b0);

assign icmp_ln505_fu_683_p2 = (($signed(tmp_1_fu_673_p4) < $signed(29'd1)) ? 1'b1 : 1'b0);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign m_axis_video_TVALID_int_regslice = grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID;

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign select_ln505_fu_695_p3 = ((icmp_ln505_fu_683_p2[0:0] == 1'b1) ? add_ln507_fu_689_p2 : 32'd0);

assign tmp_1_fu_673_p4 = {{s[31:3]}};
