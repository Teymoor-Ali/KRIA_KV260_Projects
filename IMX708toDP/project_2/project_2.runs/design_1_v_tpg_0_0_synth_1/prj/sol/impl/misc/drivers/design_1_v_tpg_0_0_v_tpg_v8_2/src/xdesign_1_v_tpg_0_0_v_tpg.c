...
void XDesign_1_v_tpg_0_0_v_tpg_Set_enableInput(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_tpg_0_0_v_tpg_WriteReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_ENABLEINPUT_DATA, Data);
}

u32 XDesign_1_v_tpg_0_0_v_tpg_Get_enableInput(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_tpg_0_0_v_tpg_ReadReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_ENABLEINPUT_DATA);
    return Data;
}

void XDesign_1_v_tpg_0_0_v_tpg_Set_passthruStartX(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_tpg_0_0_v_tpg_WriteReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_PASSTHRUSTARTX_DATA, Data);
}

u32 XDesign_1_v_tpg_0_0_v_tpg_Get_passthruStartX(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_tpg_0_0_v_tpg_ReadReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_PASSTHRUSTARTX_DATA);
    return Data;
}

void XDesign_1_v_tpg_0_0_v_tpg_Set_passthruStartY(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_tpg_0_0_v_tpg_WriteReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_PASSTHRUSTARTY_DATA, Data);
}

u32 XDesign_1_v_tpg_0_0_v_tpg_Get_passthruStartY(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_tpg_0_0_v_tpg_ReadReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_PASSTHRUSTARTY_DATA);
    return Data;
}

void XDesign_1_v_tpg_0_0_v_tpg_Set_passthruEndX(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_tpg_0_0_v_tpg_WriteReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_PASSTHRUENDX_DATA, Data);
}

u32 XDesign_1_v_tpg_0_0_v_tpg_Get_passthruEndX(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_tpg_0_0_v_tpg_ReadReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_PASSTHRUENDX_DATA);
    return Data;
}

void XDesign_1_v_tpg_0_0_v_tpg_Set_passthruEndY(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_tpg_0_0_v_tpg_WriteReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_PASSTHRUENDY_DATA, Data);
}

u32 XDesign_1_v_tpg_0_0_v_tpg_Get_passthruEndY(XDesign_1_v_tpg_0_0_v_tpg *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_tpg_0_0_v_tpg_ReadReg(InstancePtr->Design_1_v_tpg_0_0_ctrl_BaseAddress, XDESIGN_1_V_TPG_0_0_V_TPG_DESIGN_1_V_TPG_0_0_CTRL_ADDR_PASSTHRUENDY_DATA);
    return Data;
}
