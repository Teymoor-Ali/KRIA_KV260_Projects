...
architecture behav of design_1_v_tpg_0_0_v_tpg is 
    ...
    "design_1_v_tpg_0_0_v_tpg,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.392000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=9,HLS_SYN_DSP=0,HLS_SYN_FF=8885,HLS_SYN_LUT=9732,HLS_VERSION=2024_1}";
    ...
    signal icmp_ln500_fu_647_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln500_reg_715 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TKEEP : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_447_fid : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_447_ap_start : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_447_s_axis_video_TREADY : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TREADY : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_447_fid_ap_vld : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_447_ap_done : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_447_ap_ready : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_447_ap_idle : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_447_ap_continue : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_641_ap_start : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_641_ap_done : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_641_ap_idle : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_641_ap_ready : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_641_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal count_new_0_reg_436 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln503_fu_663_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_447_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready : STD_LOGIC := '0';
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done : STD_LOGIC := '0';
    signal ap_block_state4_on_subcall_done : BOOLEAN;
    signal ap_sync_grp_v_tpgHlsDataFlow_fu_447_ap_ready : STD_LOGIC;
    signal select_ln505_fu_695_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_673_p4 : STD_LOGIC_VECTOR (28 downto 0);
    signal icmp_ln505_fu_683_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln507_fu_689_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    grp_v_tpgHlsDataFlow_fu_447 : component design_1_v_tpg_0_0_v_tpgHlsDataFlow
    port map (
        ...
        height_val4 => height_read_reg_727,
        width_val7 => width_read_reg_732,
        field_id_val8 => field_id_read_reg_737,
        fid_in_val9 => fid_in,
        passthruStartX_val10 => passthruStartX_read_reg_747,
        passthruStartY_val11 => passthruStartY_read_reg_752,
        passthruEndX_val12 => passthruEndX_read_reg_757,
        passthruEndY_val13 => passthruEndY_read_reg_762,
        enableInput_val15 => enableInput_read_reg_767,
        bckgndId_val16 => bckgndId_read_reg_772,
        motionSpeed_val17 => motionSpeed_read_reg_777,
        colorFormat_val20 => colorFormat_read_reg_782,
        ZplateHorContStart_val21 => ZplateHorContStart_read_reg_787,
        ZplateHorContDelta_val22 => ZplateHorContDelta_read_reg_792,
        ZplateVerContStart_val23 => ZplateVerContStart_read_reg_797,
        ZplateVerContDelta_val24 => ZplateVerContDelta_read_reg_802,
        dpDynamicRange_val25 => dpDynamicRange_read_reg_807,
        dpYUVCoef_val26 => dpYUVCoef_read_reg_812,
        m_axis_video_TDATA => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TDATA,
        m_axis_video_TKEEP => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TKEEP,
        m_axis_video_TSTRB => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TSTRB,
        m_axis_video_TUSER => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TUSER,
        m_axis_video_TLAST => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TLAST,
        m_axis_video_TID => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TID,
        m_axis_video_TDEST => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TDEST,
        fid => grp_v_tpgHlsDataFlow_fu_447_fid,
        s => s,
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        field_id_val8_ap_vld => ap_const_logic_1,
        fid_in_val9_ap_vld => ap_const_logic_1,
        passthruStartX_val10_ap_vld => ap_const_logic_1,
        passthruStartY_val11_ap_vld => ap_const_logic_1,
        passthruEndX_val12_ap_vld => ap_const_logic_1,
        passthruEndY_val13_ap_vld => ap_const_logic_1,
        bckgndId_val16_ap_vld => ap_const_logic_1,
        motionSpeed_val17_ap_vld => ap_const_logic_1,
        ZplateHorContStart_val21_ap_vld => ap_const_logic_1,
        ZplateHorContDelta_val22_ap_vld => ap_const_logic_1,
        ZplateVerContStart_val23_ap_vld => ap_const_logic_1,
        ZplateVerContDelta_val24_ap_vld => ap_const_logic_1,
        dpDynamicRange_val25_ap_vld => ap_const_logic_1,
        dpYUVCoef_val26_ap_vld => ap_const_logic_1,
        ap_start => grp_v_tpgHlsDataFlow_fu_447_ap_start,
        s_axis_video_TVALID => s_axis_video_TVALID_int_regslice,
        s_axis_video_TREADY => grp_v_tpgHlsDataFlow_fu_447_s_axis_video_TREADY,
        enableInput_val15_ap_vld => ap_const_logic_1,
        height_val4_ap_vld => ap_const_logic_1,
        width_val7_ap_vld => ap_const_logic_1,
        colorFormat_val20_ap_vld => ap_const_logic_1,
        s_ap_vld => ap_const_logic_1,
        m_axis_video_TVALID => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID,
        m_axis_video_TREADY => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TREADY,
        fid_ap_vld => grp_v_tpgHlsDataFlow_fu_447_fid_ap_vld,
        ap_done => grp_v_tpgHlsDataFlow_fu_447_ap_done,
        ap_ready => grp_v_tpgHlsDataFlow_fu_447_ap_ready,
        ap_idle => grp_v_tpgHlsDataFlow_fu_447_ap_idle,
        ap_continue => grp_v_tpgHlsDataFlow_fu_447_ap_continue);

    grp_reg_unsigned_short_s_fu_641 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_reg_unsigned_short_s_fu_641_ap_start,
        ap_done => grp_reg_unsigned_short_s_fu_641_ap_done,
        ap_idle => grp_reg_unsigned_short_s_fu_641_ap_idle,
        ap_ready => grp_reg_unsigned_short_s_fu_641_ap_ready,
        ap_ce => ap_const_logic_1,
        d => bck_motion_en,
        ap_return => grp_reg_unsigned_short_s_fu_641_ap_return);
    ...
    regslice_both_s_axis_video_V_data_V_U : component design_1_v_tpg_0_0_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_keep_V_U : component design_1_v_tpg_0_0_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_strb_V_U : component design_1_v_tpg_0_0_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_user_V_U : component design_1_v_tpg_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_last_V_U : component design_1_v_tpg_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_id_V_U : component design_1_v_tpg_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_video_V_dest_V_U : component design_1_v_tpg_0_0_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TDATA,
        vld_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TKEEP,
        vld_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TSTRB,
        vld_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TUSER,
        vld_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TLAST,
        vld_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TID,
        vld_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TDEST,
        vld_in => grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID,
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_447_ap_done = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_447_ap_ready = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    grp_v_tpgHlsDataFlow_fu_447_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_v_tpgHlsDataFlow_fu_447_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state3) or ((ap_sync_grp_v_tpgHlsDataFlow_fu_447_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state4)))) then 
                    grp_v_tpgHlsDataFlow_fu_447_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_v_tpgHlsDataFlow_fu_447_ap_ready = ap_const_logic_1)) then 
                    grp_v_tpgHlsDataFlow_fu_447_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
    ...
    count_new_0_reg_436_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_fu_647_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                if ((icmp_ln503_fu_663_p2 = ap_const_lv1_0)) then 
                    count_new_0_reg_436 <= add_ln502_fu_657_p2;
                elsif ((icmp_ln503_fu_663_p2 = ap_const_lv1_1)) then 
                    count_new_0_reg_436 <= ap_const_lv32_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                ZplateHorContDelta_read_reg_792 <= ZplateHorContDelta;
                ZplateHorContStart_read_reg_787 <= ZplateHorContStart;
                ZplateVerContDelta_read_reg_802 <= ZplateVerContDelta;
                ZplateVerContStart_read_reg_797 <= ZplateVerContStart;
                bckgndId_read_reg_772 <= bckgndId;
                colorFormat_read_reg_782 <= colorFormat;
                dpDynamicRange_read_reg_807 <= dpDynamicRange;
                dpYUVCoef_read_reg_812 <= dpYUVCoef;
                enableInput_read_reg_767 <= enableInput;
                field_id_read_reg_737 <= field_id;
                height_read_reg_727 <= height;
                motionSpeed_read_reg_777 <= motionSpeed;
                passthruEndX_read_reg_757 <= passthruEndX;
                passthruEndY_read_reg_762 <= passthruEndY;
                passthruStartX_read_reg_747 <= passthruStartX;
                passthruStartY_read_reg_752 <= passthruStartY;
                width_read_reg_732 <= width;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_reg_715 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                count <= count_new_0_reg_436;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                icmp_ln500_reg_715 <= icmp_ln500_fu_647_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_fu_647_p2 = ap_const_lv1_1) and (icmp_ln503_fu_663_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                s <= select_ln505_fu_695_p3;
            end if;
        end if;
    end process;
    ...
    add_ln502_fu_657_p2 <= std_logic_vector(unsigned(count) + unsigned(ap_const_lv32_1));
    add_ln507_fu_689_p2 <= std_logic_vector(unsigned(s) + unsigned(ap_const_lv32_1));
    ...
    ap_block_state4_on_subcall_done_assign_proc : process(ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready, ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done)
    begin
                ap_block_state4_on_subcall_done <= ((ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready and ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_done) = ap_const_logic_0);
    end process;
    ...
    ap_sync_grp_v_tpgHlsDataFlow_fu_447_ap_ready <= (grp_v_tpgHlsDataFlow_fu_447_ap_ready or ap_sync_reg_grp_v_tpgHlsDataFlow_fu_447_ap_ready);
    fid <= grp_v_tpgHlsDataFlow_fu_447_fid;

    grp_reg_unsigned_short_s_fu_641_ap_start_assign_proc : process(ap_start, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
            grp_reg_unsigned_short_s_fu_641_ap_start <= ap_const_logic_1;
        else 
            grp_reg_unsigned_short_s_fu_641_ap_start <= ap_const_logic_0;
        end if; 
    end process;


    grp_v_tpgHlsDataFlow_fu_447_ap_continue_assign_proc : process(ap_CS_fsm_state4, ap_block_state4_on_subcall_done)
    begin
        if (((ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
            grp_v_tpgHlsDataFlow_fu_447_ap_continue <= ap_const_logic_1;
        else 
            grp_v_tpgHlsDataFlow_fu_447_ap_continue <= ap_const_logic_0;
        end if; 
    end process;

    grp_v_tpgHlsDataFlow_fu_447_ap_start <= grp_v_tpgHlsDataFlow_fu_447_ap_start_reg;
    grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TREADY <= (m_axis_video_TREADY_int_regslice and ap_CS_fsm_state4);
    icmp_ln500_fu_647_p2 <= "1" when (grp_reg_unsigned_short_s_fu_641_ap_return = ap_const_lv16_1) else "0";
    icmp_ln503_fu_663_p2 <= "1" when (add_ln502_fu_657_p2 = ap_const_lv32_A) else "0";
    icmp_ln505_fu_683_p2 <= "1" when (signed(tmp_1_fu_673_p4) < signed(ap_const_lv29_1)) else "0";
    m_axis_video_TVALID <= regslice_both_m_axis_video_V_data_V_U_vld_out;
    m_axis_video_TVALID_int_regslice <= grp_v_tpgHlsDataFlow_fu_447_m_axis_video_TVALID;
    s_axis_video_TREADY <= regslice_both_s_axis_video_V_data_V_U_ack_in;

    s_axis_video_TREADY_int_regslice_assign_proc : process(grp_v_tpgHlsDataFlow_fu_447_s_axis_video_TREADY, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            s_axis_video_TREADY_int_regslice <= grp_v_tpgHlsDataFlow_fu_447_s_axis_video_TREADY;
        else 
            s_axis_video_TREADY_int_regslice <= ap_const_logic_0;
        end if; 
    end process;

    select_ln505_fu_695_p3 <= 
        add_ln507_fu_689_p2 when (icmp_ln505_fu_683_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_1_fu_673_p4 <= s(31 downto 3);
end behav;
