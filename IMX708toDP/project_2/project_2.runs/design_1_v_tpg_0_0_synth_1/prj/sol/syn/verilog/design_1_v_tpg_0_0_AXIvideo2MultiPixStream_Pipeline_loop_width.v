...
wire   [29:0] axi_data_4_fu_241_p1;
reg   [0:0] axi_last_fu_102;
wire   [29:0] or_ln894_3_fu_311_p4;
reg    ap_block_pp0_stage0_01001;
reg    srcYUV_write_local;
wire   [9:0] tmp_s_fu_266_p4;
wire   [9:0] trunc_ln63_fu_276_p1;
wire   [9:0] tmp_19_fu_287_p4;
wire   [9:0] select_ln880_2_fu_304_p3;
wire   [9:0] select_ln880_1_fu_297_p3;
wire   [9:0] select_ln880_fu_280_p3;
reg    ap_done_reg;
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln850_fu_215_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln850_reg_355 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln850_reg_355 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        srcYUV_write_local = 1'b1;
    end else begin
        srcYUV_write_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln850_reg_355 == 1'd0) & (srcYUV_full_n == 1'b0));
end

always @ (*) begin
    ap_condition_278 = ((icmp_ln850_reg_355 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_281 = ((or_ln854_fu_227_p2 == 1'd0) & (icmp_ln850_fu_215_p2 == 1'd0) & (ap_start_int == 1'b1));
end

always @ (*) begin
    ap_condition_286 = ((icmp_ln850_reg_355 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign axi_data_4_fu_241_p1 = s_axis_video_TDATA[29:0];
...
assign or_ln894_3_fu_311_p4 = {{{select_ln880_2_fu_304_p3}, {select_ln880_1_fu_297_p3}}, {select_ln880_fu_280_p3}};

assign select_ln880_1_fu_297_p3 = ((cond[0:0] == 1'b1) ? trunc_ln63_fu_276_p1 : tmp_19_fu_287_p4);

assign select_ln880_2_fu_304_p3 = ((cond[0:0] == 1'b1) ? tmp_19_fu_287_p4 : tmp_s_fu_266_p4);

assign select_ln880_fu_280_p3 = ((cond[0:0] == 1'b1) ? tmp_s_fu_266_p4 : trunc_ln63_fu_276_p1);

assign srcYUV_din = or_ln894_3_fu_311_p4;

assign srcYUV_write = srcYUV_write_local;

assign tmp_19_fu_287_p4 = {{axi_data_fu_98[19:10]}};

assign tmp_s_fu_266_p4 = {{axi_data_fu_98[29:20]}};

assign trunc_ln63_fu_276_p1 = axi_data_fu_98[9:0];
