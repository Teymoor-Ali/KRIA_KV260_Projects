...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { height_val4_dout { I 11 vector } height_val4_num_data_valid { I 3 vector } height_val4_fifo_cap { I 3 vector } height_val4_empty_n { I 1 bit } height_val4_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { width_val7_dout { I 11 vector } width_val7_num_data_valid { I 3 vector } width_val7_fifo_cap { I 3 vector } width_val7_empty_n { I 1 bit } width_val7_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { colorFormat_val20_dout { I 8 vector } colorFormat_val20_num_data_valid { I 3 vector } colorFormat_val20_fifo_cap { I 3 vector } colorFormat_val20_empty_n { I 1 bit } colorFormat_val20_read { O 1 bit } } \
} "
}
