...
architecture rtl of design_1_v_demosaic_0_0_fifo_w16_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component design_1_v_demosaic_0_0_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_design_1_v_demosaic_0_0_fifo_w16_d2_S_ShiftReg : design_1_v_demosaic_0_0_fifo_w16_d2_S_ShiftReg
    generic map (
...
architecture rtl of design_1_v_demosaic_0_0_fifo_w16_d2_S_ShiftReg is
