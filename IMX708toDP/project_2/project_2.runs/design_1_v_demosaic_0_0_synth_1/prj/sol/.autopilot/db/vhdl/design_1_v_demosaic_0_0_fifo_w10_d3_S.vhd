...
entity design_1_v_demosaic_0_0_fifo_w10_d3_S is 
    generic (
...
architecture rtl of design_1_v_demosaic_0_0_fifo_w10_d3_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component design_1_v_demosaic_0_0_fifo_w10_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 10;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_design_1_v_demosaic_0_0_fifo_w10_d3_S_ShiftReg : design_1_v_demosaic_0_0_fifo_w10_d3_S_ShiftReg
    generic map (
...
entity design_1_v_demosaic_0_0_fifo_w10_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 10;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end design_1_v_demosaic_0_0_fifo_w10_d3_S_ShiftReg;

architecture rtl of design_1_v_demosaic_0_0_fifo_w10_d3_S_ShiftReg is
