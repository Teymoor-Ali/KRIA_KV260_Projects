...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1028", "Max" : "2080028"}
	, {"Name" : "Interval", "Min" : "1028", "Max" : "2080028"}
]}
...
set Spec2ImplPortList { 
	imgRgb { ap_fifo {  { imgRgb_dout fifo_data_in 0 30 }  { imgRgb_num_data_valid fifo_status_num_data_valid 0 5 }  { imgRgb_fifo_cap fifo_update 0 5 }  { imgRgb_empty_n fifo_status 0 1 }  { imgRgb_read fifo_port_we 1 1 } } }
	imgGamma { ap_fifo {  { imgGamma_din fifo_data_in 1 30 }  { imgGamma_num_data_valid fifo_status_num_data_valid 0 5 }  { imgGamma_fifo_cap fifo_update 0 5 }  { imgGamma_full_n fifo_status 0 1 }  { imgGamma_write fifo_port_we 1 1 } } }
