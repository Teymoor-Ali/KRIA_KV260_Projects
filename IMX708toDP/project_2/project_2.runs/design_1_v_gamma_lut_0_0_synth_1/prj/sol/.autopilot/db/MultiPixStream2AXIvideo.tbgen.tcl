...
set Spec2ImplPortList { 
	imgGamma { ap_fifo {  { imgGamma_dout fifo_data_in 0 30 }  { imgGamma_num_data_valid fifo_status_num_data_valid 0 5 }  { imgGamma_fifo_cap fifo_update 0 5 }  { imgGamma_empty_n fifo_status 0 1 }  { imgGamma_read fifo_port_we 1 1 } } }
