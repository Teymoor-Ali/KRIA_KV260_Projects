...
wire   [10:0] trunc_ln249_fu_120_p1;
reg   [10:0] trunc_ln249_reg_180;
reg    ap_block_state1;
wire   [10:0] trunc_ln250_fu_124_p1;
reg   [10:0] trunc_ln250_reg_185;
wire   [11:0] sub_i_i_fu_132_p2;
reg   [11:0] sub_i_i_reg_190;
...
wire   [31:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TDATA;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TVALID;
wire   [3:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TKEEP;
wire   [3:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_258_2_fu_96_m_axis_video_TSTRB;
...
assign empty_fu_128_p1 = width[11:0];
...
assign i_2_fu_157_p2 = (i_fu_68 + 11'd1);

assign icmp_ln256_1_fu_152_p2 = ((i_fu_68 == trunc_ln249_reg_180) ? 1'b1 : 1'b0);

assign icmp_ln256_fu_138_p2 = ((trunc_ln250_fu_124_p1 == 11'd0) ? 1'b1 : 1'b0);
...
assign sub_i_i_fu_132_p2 = ($signed(empty_fu_128_p1) + $signed(12'd4095));

assign trunc_ln249_fu_120_p1 = height[10:0];

assign trunc_ln250_fu_124_p1 = width[10:0];
