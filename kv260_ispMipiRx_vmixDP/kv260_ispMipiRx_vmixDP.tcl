...
################################################################
# This is a generated script based on design: kv260_ispMipiRx_vmixDP
#
...
# source kv260_ispMipiRx_vmixDP_script.tcl
...
set design_name kv260_ispMipiRx_vmixDP
...
proc create_hier_cell_display_pipeline { parentCell nameHier } {
  ...
  set_property CONFIG.DIN_WIDTH {92} $xlslice_0


  # Create instance: xlslice_15to8, and set properties
  set xlslice_15to8 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_15to8 ]
  set_property -dict [list \
    CONFIG.DIN_FROM {15} \
    CONFIG.DIN_TO {8} \
    CONFIG.DIN_WIDTH {16} \
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/s_axi_aclken]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconstant_2/dout] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In2]
...
proc create_hier_cell_capture_pipeline { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wiz_0_clk_275M [get_bd_pins aclk] [get_bd_pins axis_data_fifo_cap/s_axis_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins v_frmbuf_wr_0/ap_clk]
  ...
  connect_bd_net -net v_frmbuf_wr_1_interrupt [get_bd_pins v_frmbuf_wr_0/interrupt] [get_bd_pins frm_buf_irq]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins xlslice_1/Dout] [get_bd_pins v_frmbuf_wr_0/ap_rst_n]
...
\
  ...
  set_property CONFIG.NUM_MI {1} $axi_ic_accel_ctrl


  # Create instance: axi_ic_ctrl_100Mhz, and set properties
  set axi_ic_ctrl_100Mhz [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_ic_ctrl_100Mhz ]
  set_property CONFIG.NUM_MI {4} $axi_ic_ctrl_100Mhz


  # Create instance: axi_ic_ctrl_275Mhz, and set properties
  set axi_ic_ctrl_275Mhz [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_ic_ctrl_275Mhz ]
  ...
  set proc_sys_reset_275MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_275MHz ]

  # Create instance: proc_sys_reset_550MHz, and set properties
  set proc_sys_reset_550MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_550MHz ]
  ...
  connect_bd_intf_net -intf_net PS_0_M_AXI_HPM1_FPD [get_bd_intf_pins PS_0/M_AXI_HPM1_FPD] [get_bd_intf_pins axi_ic_ctrl_275Mhz/S00_AXI]
  ...
  connect_bd_intf_net -intf_net capture_pipeline_m_axi_mm_video [get_bd_intf_pins PS_0/S_AXI_HP1_FPD] [get_bd_intf_pins capture_pipeline/m_axi_mm_video]
  connect_bd_intf_net -intf_net display_pipeline_M00_AXI [get_bd_intf_pins PS_0/S_AXI_HP0_FPD] [get_bd_intf_pins display_pipeline/M00_AXI]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins PS_0/M_AXI_HPM0_LPD] [get_bd_intf_pins axi_ic_ctrl_100Mhz/S00_AXI]

  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins clk_wiz_0/clk_275M] [get_bd_pins PS_0/maxihpm0_fpd_aclk] [get_bd_pins PS_0/maxihpm1_fpd_aclk] [get_bd_pins PS_0/saxi_lpd_aclk] [get_bd_pins PS_0/saxihp0_fpd_aclk] [get_bd_pins PS_0/saxihp1_fpd_aclk] [get_bd_pins PS_0/saxihp2_fpd_aclk] [get_bd_pins PS_0/saxihp3_fpd_aclk] [get_bd_pins PS_0/saxihpc0_fpd_aclk] [get_bd_pins PS_0/saxihpc1_fpd_aclk] [get_bd_pins axi_ic_accel_ctrl/ACLK] [get_bd_pins axi_ic_accel_ctrl/M00_ACLK] [get_bd_pins axi_ic_accel_ctrl/S00_ACLK] [get_bd_pins axi_ic_ctrl_275Mhz/ACLK] [get_bd_pins axi_ic_ctrl_275Mhz/M00_ACLK] [get_bd_pins axi_ic_ctrl_275Mhz/M01_ACLK] [get_bd_pins axi_ic_ctrl_275Mhz/S00_ACLK] [get_bd_pins axi_vip_0/aclk] [get_bd_pins capture_pipeline/aclk] [get_bd_pins display_pipeline/clk] [get_bd_pins proc_sys_reset_275MHz/slowest_sync_clk]
  connect_bd_net -net ARESETN_1 [get_bd_pins proc_sys_reset_100MHz/interconnect_aresetn] [get_bd_pins axi_ic_ctrl_100Mhz/ARESETN]
  connect_bd_net -net PS_0_emio_gpio_o [get_bd_pins PS_0/emio_gpio_o] [get_bd_pins capture_pipeline/Din] [get_bd_pins display_pipeline/Din] [get_bd_pins xlslice_2/Din]
  ...
  connect_bd_net -net clk_wiz_0_clk_100M [get_bd_pins clk_wiz_0/clk_100M] [get_bd_pins PS_0/maxihpm0_lpd_aclk] [get_bd_pins axi_ic_ctrl_100Mhz/ACLK] [get_bd_pins axi_ic_ctrl_100Mhz/M00_ACLK] [get_bd_pins axi_ic_ctrl_100Mhz/M01_ACLK] [get_bd_pins axi_ic_ctrl_100Mhz/M02_ACLK] [get_bd_pins axi_ic_ctrl_100Mhz/M03_ACLK] [get_bd_pins axi_ic_ctrl_100Mhz/S00_ACLK] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins capture_pipeline/lite_aclk] [get_bd_pins display_pipeline/s_axi_aclk] [get_bd_pins proc_sys_reset_100MHz/slowest_sync_clk]
  ...
  connect_bd_net -net display_pipeline_vid_active_video [get_bd_pins display_pipeline/vid_active_video] [get_bd_pins PS_0/dp_live_video_in_de]
  connect_bd_net -net display_pipeline_vid_data [get_bd_pins display_pipeline/vid_data] [get_bd_pins PS_0/dp_live_video_in_pixel1]
  connect_bd_net -net display_pipeline_vid_hsync [get_bd_pins display_pipeline/vid_hsync] [get_bd_pins PS_0/dp_live_video_in_hsync]
  connect_bd_net -net display_pipeline_vid_vsync [get_bd_pins display_pipeline/vid_vsync] [get_bd_pins PS_0/dp_live_video_in_vsync]
  connect_bd_net -net display_pipeline_video_clk [get_bd_pins display_pipeline/video_clk] [get_bd_pins PS_0/dp_video_in_clk]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins proc_sys_reset_275MHz/interconnect_aresetn] [get_bd_pins axi_ic_accel_ctrl/ARESETN] [get_bd_pins axi_ic_ctrl_275Mhz/ARESETN]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_275MHz/peripheral_aresetn] [get_bd_pins axi_ic_accel_ctrl/M00_ARESETN] [get_bd_pins axi_ic_accel_ctrl/S00_ARESETN] [get_bd_pins axi_ic_ctrl_275Mhz/M00_ARESETN] [get_bd_pins axi_ic_ctrl_275Mhz/M01_ARESETN] [get_bd_pins axi_ic_ctrl_275Mhz/S00_ARESETN] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins capture_pipeline/aresetn] [get_bd_pins display_pipeline/resetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins axi_ic_ctrl_100Mhz/M00_ARESETN] [get_bd_pins axi_ic_ctrl_100Mhz/M01_ARESETN] [get_bd_pins axi_ic_ctrl_100Mhz/M02_ARESETN] [get_bd_pins axi_ic_ctrl_100Mhz/M03_ARESETN] [get_bd_pins axi_ic_ctrl_100Mhz/S00_ARESETN] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins capture_pipeline/lite_aresetn] [get_bd_pins display_pipeline/s_axi_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins PS_0/pl_ps_irq1]
  connect_bd_net -net xlconstant_0_ap1302_standby [get_bd_pins xlconstant_0/dout] [get_bd_ports ap1302_standby]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins xlslice_2/Dout] [get_bd_ports ap1302_rst_b]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins PS_0/pl_clk0] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins PS_0/pl_resetn0] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins display_pipeline/ext_reset_in] [get_bd_pins proc_sys_reset_100MHz/ext_reset_in] [get_bd_pins proc_sys_reset_275MHz/ext_reset_in] [get_bd_pins proc_sys_reset_550MHz/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x80040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs axi_iic_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs display_pipeline/clk_wiz_0/s_axi_lite/Reg] -force
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs capture_pipeline/mipi_csi2_rx_subsyst_0/csirxss_s_axi/Reg] -force
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs capture_pipeline/v_frmbuf_wr_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xB0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs display_pipeline/v_mix_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs display_pipeline/v_tc_0/ctrl/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces capture_pipeline/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs PS_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces display_pipeline/v_mix_0/Data_m_axi_mm_video1] [get_bd_addr_segs PS_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces display_pipeline/v_mix_0/Data_m_axi_mm_video2] [get_bd_addr_segs PS_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces display_pipeline/v_mix_0/Data_m_axi_mm_video3] [get_bd_addr_segs PS_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces display_pipeline/v_mix_0/Data_m_axi_mm_video4] [get_bd_addr_segs PS_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces display_pipeline/v_mix_0/Data_m_axi_mm_video5] [get_bd_addr_segs PS_0/SAXIGP2/HP0_DDR_LOW] -force
